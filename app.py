...
##APP##
##FRONT##
st.set_page_config(page_title="FacturaElectro", page_icon="☕", layout="centered")

st.write("##")
st.title("¡SEBASTYANDRES FACTURAS!")

c1,c2 = st.columns(2)
with c1:
    st.write("##")
    st.image("assets/descarga.jpeg")
...
st.write("##")
st.caption("© 2021 Todos los derechos reservados")